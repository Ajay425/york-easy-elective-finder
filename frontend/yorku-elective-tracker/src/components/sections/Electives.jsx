  ...
  {selectedCourse && (
    ...
    >
      ...
      <p className="text-xs text-yellow-200 mt-2">
        Note: Always verify the prerequisites and course details with the official university resources.
      </p>

      {/* Display all sections and instructors separated by term */}
      {selectedCourse.terms?.length > 0 && (
        <div className="mt-4 space-y-6">
          ...
          {selectedCourse.terms.some((t) => t.term === "F") && (
            <div>
              <h5 className="text-lg text-yellow-300 font-semibold mb-2">
                🍂 Fall
              </h5>
          ...
          {selectedCourse.terms.some((t) => t.term === "W") && (
            <div>
              <h5 className="text-lg text-blue-300 font-semibold mb-2">
                ❄️ Winter
              </h5>
              <div className="space-y-3">
                {selectedCourse.terms
